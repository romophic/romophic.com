    ...
    return (
        <FloatingPortal>
            <div
                ...
                className="z-50 w-80 rounded-xl border bg-popover p-4 text-popover-foreground shadow-lg outline-none animate-in fade-in-0 data-[state=closed]:animate-out data-[state=closed]:fade-out-0 zoom-in-95"
            >
                {previewData.image && (
                    <img
                ...
                <h4 className="flex items-center gap-2 font-semibold leading-none tracking-tight text-sm">
                    {previewData.title}
                </h4>
