...
-   **`blog/`**: Blog posts. Supports nesting.
    -   *Standard Post:* `folder/index.mdx` or `file.md`.
    -   *Series/Sub-posts:* A folder containing multiple `.mdx` files or subfolders. The project logic (`data-utils.ts`) treats these as connected content.
